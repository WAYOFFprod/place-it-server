...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.canvas.driver' => 'string',
            'filesystems.disks.canvas.root' => 'string',
            'filesystems.disks.canvas.throw' => 'boolean',
...
'app.aliases.View','app.aliases.Vite','app.client','app.live_url','auth.defaults.guard',
...
'filesystems.disks.s3.throw','filesystems.disks.canvas.driver','filesystems.disks.canvas.root','filesystems.disks.canvas.throw','filesystems.links./var/www/html/public/storage',
...
'fortify.features','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'dusk.login','dusk.logout','dusk.user','login.store','logout',
'password.email','password.update','register.store','password.confirmation','password.confirm.store',
...
'APP_URL','DUSK_CLIENT','DUSK_HEADLESS_DISABLED','APP_LOCALE','APP_FALLBACK_LOCALE',
...
'MEMCACHED_HOST','LIVE_URL','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
...
'VITE_APP_NAME','VITE_PORT','SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_NO_ANALYTICS',
...
'DUSK_CLIENT','WWWGROUP','WWWUSER','APP_SERVICE',);
